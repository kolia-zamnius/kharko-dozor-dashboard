...
This codebase has opinionated patterns documented end-to-end in
[**`CLAUDE.md`**](./CLAUDE.md). Read the relevant sections before changing code
in that area — most "how should I structure this?" questions are answered there.
...
- A11y fixes.
- Documentation — code comments, JSDoc, CLAUDE.md updates that reflect real changes.
...
- Major visual identity / theme work — deliberately unpinned until the functional
  layer settles (see `CLAUDE.md` → "Design").
